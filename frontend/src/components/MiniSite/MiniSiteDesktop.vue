  ...
  <div class="mini-site-desktop">
    ...
    <main class="mini-site-main">
      <component
        ...
        :show-exclusive-access="getPageSetting('home', 'show_exclusive_access', true)"
        :show-community="getPageSetting('home', 'show_community', true)"
        :show-learning="getPageSetting('home', 'show_learning', true)"
