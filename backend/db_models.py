...
clubs = Table(
    ...
    Column("whatsapp_groups", Text, nullable=False, server_default=""),
    Column("social_media", JSONB, nullable=False, server_default="[]"),
    Column("officers", JSONB, nullable=False, server_default="[]"),
