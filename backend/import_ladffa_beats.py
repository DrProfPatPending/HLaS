#!/usr/bin/env python3
"""Import LADFFA beat data from CSV into clubs.config.json."""
...
BEATS_CSV_PATH = os.path.join(BACKEND_DIR, 'LADFFA_beats.csv')
CLUB_SHORT_NAME = 'LADFFA'


def import_ladffa_beats() -> int:
